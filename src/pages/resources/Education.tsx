...
import resourcesEducationHeroBg from "@/assets/resources-education-hero-bg.jpg";
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${resourcesEducationHeroBg})` }}
        ></div>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center text-white">
          <div ref={titleRef} className={`transition-all duration-1000 ease-out ${
            ...
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
              Educational <span className="text-accent">Materials</span>
            </h1>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground">Learning resources and guides will be available here.</p>
          </div>
        </div>
      </section>
